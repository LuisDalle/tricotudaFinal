...
CREATE TABLE `tb_pagamentos` (
  `PK_PagamentoID` int NOT NULL AUTO_INCREMENT,
  `FK_PedidoID` int NOT NULL,
  `NM_Valor` decimal(10,2) NOT NULL,
  `TX_StatusPagamento` varchar(50) NOT NULL,
  `DT_DataPagamento` date DEFAULT NULL,
  ...
  PRIMARY KEY (`PK_PagamentoID`),
  KEY `FK_PedidoID` (`FK_PedidoID`),
  CONSTRAINT `tb_pagamentos_ibfk_1` FOREIGN KEY (`FK_PedidoID`) REFERENCES `tb_pedidos` (`PK_PedidoID`)
