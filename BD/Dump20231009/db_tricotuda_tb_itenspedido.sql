...
CREATE TABLE `tb_itenspedido` (
  ...
  `NM_PrecoUnitario` decimal(10,2) NOT NULL,
  ...
  CONSTRAINT `tb_itenspedido_ibfk_1` FOREIGN KEY (`FK_PedidoID`) REFERENCES `tb_pedidos` (`PK_PedidoID`),
  CONSTRAINT `tb_itenspedido_ibfk_2` FOREIGN KEY (`FK_ProdutoID`) REFERENCES `tb_produtos` (`PK_ProdutoID`)
