...
CREATE TABLE `tb_produtos` (
  `PK_ProdutoID` int NOT NULL AUTO_INCREMENT,
  `TX_Nome` varchar(255) NOT NULL,
  `TX_Descricao` text,
  `NM_Preco` decimal(10,2) NOT NULL,
  `NM_Estoque` int NOT NULL,
  ...
  PRIMARY KEY (`PK_ProdutoID`),
  KEY `FK_CategoriaID` (`FK_CategoriaID`),
  CONSTRAINT `tb_produtos_ibfk_1` FOREIGN KEY (`FK_CategoriaID`) REFERENCES `tb_categorias` (`PK_CategoriaID`)
